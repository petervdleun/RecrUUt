...
# Data import
db = pd.read_csv('data/wysc_test.csv', encoding='utf-8-sig')
...
with tab1:
    ...
    if pctmin > min_minutes_perc:
        ...
        def generate_pdf(encoded_img, encoded_img3, fig2):
            ...
            fc_utrecht_logo_path = "C:/Users/fcvanderleun01/OneDrive - FC Utrecht BV/Documents/fc-utrecht-2021-rgb.png"
            ...
            # # New section (e.g., "MINUTES PLAYED")
            # # Move to the next section
            # y_position -= 40

            # pdf.setFont(label_font, label_font_size)
            # pdf.setFillColorRGB(*label_color)
            # pdf.drawString(x_position, y_position, "MINUTES PLAYED")

            # pdf.setFont(value_font, value_font_size)
            # pdf.setFillColorRGB(*value_color)
            # pdf.drawString(x_position + 200, y_position, str(min_played))
